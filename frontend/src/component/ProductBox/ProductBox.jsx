...
export default function ProductBox({ img, title, children, route }) {
    return (
        <div className='box-container hover:opacity-75 transition-all duration-400 '>
            <Card style={{ width: '18rem', height: "22rem", display: "relative", }} className='bg-primaryText'>
                ...
                <Card.Body>
                    ...
                    <Card.Title style={{ textAlign: 'end' }} className='text-mainPrimary'>{title}</Card.Title>
                    <Card.Text>
                        {children}
                    </Card.Text>
