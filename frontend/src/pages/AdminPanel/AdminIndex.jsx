    ...
    return (
        <div className=' flex  flex-row-reverse items-start primary-gradient '>
            <span className='lg:block hidden w-1/5  min-w-[15rem] '>
                <AdminSideBar onSlideShow={profileClick} setOnSlideShow={setProfileClick} />
            </span>
            <div className="w-full lg:w-4/5 flex flex-col shadow-md bg-primaryText rounded-md m-4">
